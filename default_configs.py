default_configs = {
    'acl': {
        ...
        'exim4-config_local_deny_exceptions': {
            'prio': 20,
            'content': [
                '',
        ...
        'exim4-config_check_rcpt': {
            ...
            'content': [
                ...
                '    control = dkim_disable_verify',
                '',
                '  # disable dkim for outlook, since they make dkim checks, but break dkim',
                '  warn',
                '    hosts = *.outbound.protection.outlook.com',
                '    control = dkim_disable_verify',
                '',
    ...
    'transport': {
        ...
        'exim4-config_remote_smtp_smarthost': {
            'prio': 30,
            'content': [
                '',
        ...
        'exim4-config_address_directory': {
            'prio': 35,
            'content': [
